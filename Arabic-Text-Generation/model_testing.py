...
def model_testing_word(text, number_of_words, text_normalization, text_to_sequence, words_index, pad_sequences, max_length, index_to_words, word_sequence_to_text, all_words, checkpoint_filepath):
